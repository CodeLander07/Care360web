...
export default async function UserDashboardPage() {
  ...
  const [consultations, appointments, reminders, drugs] = await Promise.all([
  ...
  return (
    <div className="p-8">
      <h1 className="mb-8 text-2xl font-semibold text-text-primary">Welcome back</h1>
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-2">
        <GlassCard className="p-6">
          ...
          <div className="space-y-2">
            ...
            <Link href="/dashboard/user/appointments" className="block text-text-secondary hover:text-teal">View appointments</Link>
